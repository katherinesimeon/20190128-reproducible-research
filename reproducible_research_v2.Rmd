...
* Keep data, methods, and outputs separate (makes it **reliable**)      
...
```{r, eval=FALSE} 
rrtools::create_compendium("packagename")
```
...
See more info [here](https://rmarkdown.rstudio.com/lesson-6.html).
